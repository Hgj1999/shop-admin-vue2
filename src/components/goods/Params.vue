  ...
  <div>
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-button size="mini" type="primary"
                  icon="le-icon-edit" @click="showEditDialog(scope.row.attr_id)">编辑</el-button>
                <el-button size="mini" type="danger"
                  icon="le-icon-delete" @click="removeParams(scope.row.attr_id)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-tab-pane>
    ...
    <el-dialog
      ...
      <el-form ref="editFormRef" :model="editForm"
        label-width="100px" :rules="editFormRules">
        <el-form-item :label="titleText" prop="attr_name">
  ...
  methods: {
    ...
    async getParamsData () {
      ...
      res.data.forEach(item => {
        ...
        // 保证每一行都有自己的inputVisible和inputValue避免出现公用BUG
        // 控制文本框的显示与隐藏
