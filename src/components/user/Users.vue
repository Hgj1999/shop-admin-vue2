  ...
  <div>
      ...
      <el-table :data="userList"
        ...
        <el-table-column align="center" label="状态">
          <template v-slot="state">
            <!-- {{state.row}}里面有userList里这一行的所有数据 -->
            <el-switch
        ...
        <el-table-column align="center" width="200px" label="操作">
          <template v-slot="edit">
            <!-- 编辑按钮 v-slot="operation" -->
            <el-button type="primary" icon="el-icon-edit"
            size="mini" @click="showEditDialog(edit.row.id)"></el-button>
            <!-- 删除按钮 -->
            <el-button type="danger" icon="el-icon-delete"
              size="mini" @click="removeUserById(edit.row.id)"></el-button>
            <!-- 分配角色按钮 -->
            <el-tooltip effect="dark" content="分配角色" placement="top" :enterable="false">
              <el-button type="warning" icon="el-icon-setting"
                size="mini" @click="setRole(edit.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog
      ...
      <el-form :model="editForm" :rules="editFormRules"
        ref="editFormRef" label-width="70px" status-icon>
